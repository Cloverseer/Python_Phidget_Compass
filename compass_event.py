...
"""
This code only produces bearing data for a set period of time before Phidgets closes the device

Look at the compass_non_event.py for greater control over the compass
